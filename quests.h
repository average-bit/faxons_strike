...
public:
    ...
    {
        {"ALC",{"alchemist","Academy of Arcane Science","Dilina McNerian","she"}},
        {"BRD",{"bard","Silken Gauntlet","William Corufost","he","Imaryn"}},
        {"CL",{"cleric","Shining Shield Mercenaries","Denouncer Alshea","she"}},
        {"ENC",{"enchanter","Academy of Arcane Science","Azlynn","he"}},
        {"MAG",{"magician","Academy of Arcane Science","Malsis","he","Alshan"}},
        {"NEC",{"necromancer","House Slaerin","Corious Slaerin","he"}},
        {"RGE",{"rogue","Shining Shield Mercenaries","Necorik the Ghost","he"}},
        {"SK",{"shadowknight","Shining Shield Mercenaries","Malethai Crimsonhand","he"}},
        {"WAR",{"warrior","Freeport Militia","Commander Nothard","he"}},
        {"WIZ",{"wizard","Academy of Arcane Science","Sivrendesh","he"}}
    };

    QMap<QString,QVector<QString>> QeynosHumanClassGreetings_VectorMap =
    {
        {"ALC",{"alchemist","Anagogical Order","Jergish Anaebarum","he"}},
        {"BRD",{"bard","Qeynos Troupe","Thrush Baird","he"}},
        {"CL",{"cleric","Defenders of Erollisi Marr","Vedilion Brithstar","he"}},
        {"ENC",{"enchanter","Anagogical Order","Shiassa Radian","she"}},
        {"MAG",{"magician","Anagogical Order","Ammathor Lithkin","he"}},
        {"MNK",{"monk","Order of the Silent Fist","Master T'an Chen","he"}},
        {"PAL",{"paladin","Temple of Mithaniel Marr","Sir Hanst Breach","he"}},
        {"RGE",{"rogue","Beggar's Quarter","Snyde Cragsmear","he"}},
        {"WAR",{"warrior","Qeynos Guard House","Roger Stoutheart","he"}},
        {"WIZ",{"wizard","Anagogical Order","Gadenon Flamefist","he"}}
    };

    QMap<QString,QVector<QString>> SurefallGladeHumanClassGreetings_VectorMap =
    {
        {"DRD",{"druid","Jaggedpine Treefolk","Shiol'Anara","she"}},
        {"RAN",{"ranger","Protectors of the Pine","Sigmor Fallbourne","he"}}
    };

    QMap<QString,QVector<QString>> FayspiresELFClassGreetings_VectorMap =
    {
        {"ALC",{"alchemist","College of High Magic","Silnea Aesiowe","she"}},
        {"CL",{"cleric","Church of Tunare","Tessarina Starshimmer","she"}},
        {"ENC",{"enchanter","College of High Magic","Casalandria Lyssia","she"}},
        {"MAG",{"magician","College of High Magic","Fethinar Silspin","he"}},
        {"PAL",{"paladin","Paladins of Tunare","Sir Lothwin Galiel","he"}},
        {"WIZ",{"wizard","College of High Magic","Lyriam Kaelean","he"}}
    };

    QMap<QString,QVector<QString>> TethelinELFClassGreetings_VectorMap =
    {
        {"BRD",{"bard","Songweavers of Tunare","Torenia Eaglesong","she"}},
        {"DRD",{"druid","Keepers of the Glade","Dawnseer Mistwelder,","he"}},
        {"RAN",{"ranger","Scouts of Tunare","Lythen Trueshot","he"}},
        {"RGE",{"rogue","Scouts of Tunare","Eterin Nitegazer","he"}}
    };

    QMap<QString,QVector<QString>> NeriakDarkElfClassGreetings_VectorMap =
    {
        {"ALC",{"alchemist","Spurned","Raemiss" "D`Mariji","he"}},
        {"CL",{"cleric","Church of Innoruuk","Theologist S`Tai","he"}},
        {"ENC",{"enchanter","Spurned","Dominary K`Jartan","he"}},
        {"MAG",{"magician","Spurned","Elementalist R`Virr","he"}},
        {"NEC",{"necromancer","Spurned","Grand Defiler J`Narus","he"}},
        {"RGE",{"rogue","Ebon Mask","Kriyn","she"}},
        {"SK",{"shadowknight","Lodge of the Dead","Zethril Do`Vexis","he"}},
        {"WAR",{"warrior","Indigo Brotherhood","Scornmaster U`Dedne","he"}},
        {"WIZ",{"wizard","Spurned","Sorceress X`Lottl","she"}},
    };

    QMap<QString,QVector<QString>> KlickAnonGnomeGreetings_VectorMap =
    {
        {"ALC",{"alchemist","Mechanamagical College","Lanlin Ogledmaggen","he"}},
        {"CL",{"cleric","Temple of Brell","Teka Harnswoof","she"}},
        {"ENC",{"enchanter","Mechanamagical College","Professor Temwiddle","she"}},
        {"MAG",{"magician","Mechanamagical College","Werlib Quackook","he"}},
        {"NEC",{"necromancer","Mechanamagical College","Grear Hosrottle","he"}},
        {"RGE",{"rogue","Junk Mongers","Mistress Briva","she"}},
        {"WAR",{"warrior","Klick'Anon Watch","Captain Buntattle","he"}},
        {"WIZ",{"wizard","Mechanamagical College","Pazelfun Pansoof","he"}},
    };

    QMap<QString,QVector<QString>> MoradhimDwarfGreetings_VectorMap =
    {
        {"CL",{"cleric","Church of Below","Bishop Gundar","he"}},
        {"PAL",{"paladin","Doomseekers","Ungrist the Prophet","he"}},
        {"RGE",{"rogue","Miners Guild 231","Foreman Druza","she"}},
        {"WAR",{"warrior","Stone Guard","Field General Oxfist","he"}},
    };

    QMap<QString,QVector<QString>> GrobbTrollGreetings_VectorMap =
    {
        {"SK",{"shadowknight","Shadowknights of Nightkeep","Underlord Solthe","he"}},
        {"SHA",{"shaman","Dark Ones","Hierophant Koligo","he"}},
        {"WAR",{"warrior","Da Bashers","Warlord Jurglash","he"}},
    };

    QMap<QString,QVector<QString>> HalasBarbarianGreetings_VectorMap =
    {
        {"RGE",{"rogue","Eyes of the Tribunal","Juno Felligan","she"}},
        {"SHA",{"shaman","Seers of the Tribunal","Beril O'Leary","he"}},
        {"WAR",{"warrior","Wolves of the North","Marik McPherson","he"}},
    };

    QMap<QString,QVector<QString>> RivervaleHalflingGreetings_VectorMap =
    {
        {"CL",{"cleric","Temple of Bristlebane","Pora Meepup","she"}},
        {"DRD",{"druid","Stormreapers","Deke Gabbins","he"}},
        {"RGE",{"rogue","Deep Pockets","Walt Deeppockets","he"}},
        {"WAR",{"warrior","Guardians of the Vale","Sheriff Hopper","he"}},
    };

    QMap<QString,QVector<QString>> HighbourneEruditeGreetings_VectorMap =
    {
        {"ALC",{"alchemist","Alchemist's Guild","Melina Quiscellin","she"}},
        {"CL",{"cleric","Hand of Quellious","Arch Bishop Erah","he"}},
        {"ENC",{"enchanter","Craft Keepers","Master Delar","he"}},
        {"MAG",{"magician","Gate Callers","Master Veljhan","he"}},
        {"NEC",{"necromancer","Hidden","Retainer Alishai","he"}},
        {"PAL",{"paladin","Peacekeepers","Zulan Sunshield","she"}},
        {"SK",{"shadowknight","Hidden","Desh the Harvester","he"}},
        {"WIZ",{"wizard","Crimson Hand","Master Rayne","she"}},
    };

    QMap<QString,QVector<QString>> OggokOgreGreetings_VectorMap =
    {
        {"NEC",{"necromancer","Temple of Greenblood","Asogwe Greth","she"}},
        {"SK",{"shadowknight","Temple of Greenblood","Greenblood Yurgat","he"}},
        {"SHA",{"shaman","Chosen of Gunthak","Gunthak","he"}},
        {"WAR",{"warrior","Craknek Warriors","Warlord Brogar","he"}},
    };
...
public slots:
    ...
    QVector<QString> CheckYoPockets(QByteArray ID_IP_PORT, QByteArray opholder, QString QuestsID);

    QByteArray QuestMenus(QByteArray ID_IP_PORT, QByteArray Clients_Last_MessageNumber, QByteArray Clients_Last_FB_MessageNumber, QByteArray opholder, QString QuestsID);
