...
public:
    ...
    static QByteArray UpdateChannelMaps(QByteArray ClientID, QByteArray ClientsIP, QByteArray ClientsPort);
...
private slots:
    ...
    void on_Icon_lineEdit_Item_Name_7_textChanged(const QString &arg1);
    ...
    void on_lineEdit_247_textChanged(const QString &arg1);
