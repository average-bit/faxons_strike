...
QByteArray xorpacket::Recompress42EC(QByteArray ClientID, QByteArray ClientsIP, QByteArray ClientsPort, QList <QByteArray> mylist1, QString CharSelectID1, QByteArray StatsChange1, QString HoldOldHP1, int NewCurrentHP1, int NewCurrentPOW1, int MyNewHP)
{
    ...
    //qDebug() << "NewHP Before DMG =" << NewReverseHP1;
    ...
    //qDebug() << "NewHP After DMG =" << NewReverseHP1;
    ...
    //qDebug() << "NewHPMax After DMG =" << MaxReverseHP2;
    ...
    if((HoldOldHP1 != "YES" && NewReverseHP1 < MaxReverseHP2) || (NewReverseHP1 == MaxReverseHP2))
    {
        ...
        //qDebug() << "Add HoT =" << NewCurrentHP1;
        Total = NewReverseHP1 + NewCurrentHP1;
        //qDebug() << "NewHP After HoT =" << Total;
        ...
        //qDebug() << "Final Current HP =" << Total;
        QString NewHP = QString("%1").arg(Total,4,16,QLatin1Char('0')).toUpper();
        HP1 = NewHP.mid(0,2);
        HP2 = NewHP.mid(2,2);
        QString NewReverseHP = HP2 + HP1;
        //qDebug() << "NewReverseHPHEX =" << NewReverseHP.toUpper();
        ...
        //qDebug() << "hpOld_value" << Old_value;
        //New_value = NewReverseHP.toUtf8();
        int New_value2 = NewReverseHP.toInt(nullptr,16);
        //qDebug() << "hpNew_value" << New_value2;
        int Output_Xor = Old_value ^ New_value2;
        Output_Xor_2 = QString("%1").arg(Output_Xor,4,16,QLatin1Char('0'));
        //qDebug() << "hpOutput_Xor_2" << Output_Xor_2;
    ...
    //qDebug() << "CurrentHP1 = p13.StatsChange =" << CurrentHP1;
    ...
    if(HoldOldHP1 != "YES")
    {
        ...
        //qDebug() << "OldCurrentPOW" << NewReversePOW1;
        //qDebug() << "Add PoT" << NewCurrentPOW1;
        ...
        //qDebug() << "POWOld_value" << Old_value;
        //New_value = NewReversePOW.toUtf8();
        New_value2 = NewReversePOW.toLongLong(nullptr,16);
        //qDebug() << "POWNew_value" << New_value2;
        Output_Xor = Old_value ^ New_value2;
        Output_Xor_2 = QString("%1").arg(Output_Xor,4,16,QLatin1Char('0'));
        //qDebug() << "POWOutput_Xor_2" << Output_Xor_2;
    ...
    //New_value = NewReverseHoT.toUtf8();
    ...
    //New_value = NewReversePoT.toUtf8();
    ...
    do
    {
        ...
        if (holdit != 0x00)
        {
            ...
            if    (encarat1 == 402  || encarat1 == 472  || encarat1 == 804  || encarat1 == 1206
        ...
        else
        {
            ...
            do
            {
                ...
                if(
                        encarat1 == 402  || encarat1 == 472  || encarat1 == 804  || encarat1 == 1206
                        || encarat1 == 1608 || encarat1 == 2010 || encarat1 == 2412
                        || encarat1 == 2814 || encarat1 == 3216 || encarat1 == 3618 || encarat1 == 4020
                        || encarat1 == 4422 || encarat1 == 4824 || encarat1 == 5226 || encarat1 == 5628
                        || encarat1 == 6030 || encarat1 == 6432 || encarat1 == 6834 || encarat1 == 7236
    ...
    Add42ECtoDB(ClientID,ClientsIP,ClientsPort);
